...
class ATCAdapter {
    ...
    detect(payload) {
        if (typeof payload !== 'object' || payload === null)
            return false;
        const p = payload;
        return (p.atc_version !== undefined &&
