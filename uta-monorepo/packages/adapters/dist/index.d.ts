...
export type { TrustAdapter, UniversalTrustSchema, UTSSubject, UTSIdentity, UTSTrust, UTSCapabilities, UTSPolicy, UTSProvenance, UTSLifecycle, UTSFormat, TrustEvidence, VerifyOptions, VerifyResult, IssueInput, IssuerKeys, EngineConfig, DetectResult, NativeFormat, SubjectType, KeyAlgorithm, TEEType, Confidence, EvidenceType, EvidenceResult, Protocol, FilesystemAccess, ShellAccess, ProvenanceSource, } from '../core/types.js';
...
export declare function createEngineWithAllAdapters(config?: {
    issuer_keys?: any;
}): TrustEngine;
