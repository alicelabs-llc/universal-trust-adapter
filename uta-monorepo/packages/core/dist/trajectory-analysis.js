...
exports.MAX_ATTACK_CHAIN_LENGTH = exports.MAX_TRAJECTORY_WINDOW = exports.TRAJECTORY_VERSION = exports.ATTACK_CHAIN_PATTERNS = void 0;
exports.detectAttackChains = detectAttackChains;
exports.buildDataFlowGraph = buildDataFlowGraph;
exports.scoreTrajectory = scoreTrajectory;
const node_crypto_1 = require("node:crypto");
// ============================================================================
// Predefined attack chain patterns
// ============================================================================
exports.ATTACK_CHAIN_PATTERNS = [
    {
        pattern_id: 'AC-001',
 ...
 */
function detectAttackChains(calls) {
    const detections = [];
    for (const pattern of exports.ATTACK_CHAIN_PATTERNS) {
        ...
        for (let i = 0; i <= calls.length - pattern.sequence.length; i++) {
            ...
            if (duration > pattern.max_window_ms)
                continue;
 ...
 */
function checkDataFlowBetweenCalls(calls) {
 ...
 */
function buildDataFlowGraph(calls) {
    const nodes = [];
    const edges = [];
    const exfiltrationPaths = [];
    for (const call of calls) {
        // Create node for the call's output
        const outputHash = (0, node_crypto_1.createHash)('sha256')
            .update(JSON.stringify(call.result || ''))
            .digest('hex');
        const isSensitive = SENSITIVE_DATA_PATTERNS.some(p => p.test(JSON.stringify(call.result || '')) ||
 ...
 */
function traceBackPath(targetNode, allNodes, allEdges) {
    const path = [targetNode.node_id];
 ...
 */
function scoreTrajectory(calls) {
...
// Constants
// ============================================================================
exports.TRAJECTORY_VERSION = '1.0.0';
exports.MAX_TRAJECTORY_WINDOW = 1000; // max calls to analyze
exports.MAX_ATTACK_CHAIN_LENGTH = 10; // max steps in a chain
