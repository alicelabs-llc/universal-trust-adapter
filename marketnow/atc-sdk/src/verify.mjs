...
export async function verifyATC(atc, options = {}) {
  // ATC/1.4 (v1.2.0): production ledger envelopes auto-dispatch to the
  // unified verifier (same path as verifyATCSync).
  if (isLedgerCard(atc)) {
...
export function verifyATCSync(atc, options = {}) {
  // ATC/1.4 (v1.2.0): production ledger envelopes auto-dispatch to the
  // unified verifier — the real cards from the MarketNow ledger verify with
  // real Ed25519 instead of failing spec_version dispatch.
