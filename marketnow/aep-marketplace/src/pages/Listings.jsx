...
const CONTENT = {
  en: {
    ...
    problems: [
      { claim: '"9,248 verified MCP-compatible skills"', reality: '66,496' },
      {
    ...
    listings: [
      ...
      },
      {
        ...
        whatWeFixed: [
          ...
          'Our server-card.json is up to date with current numbers (66,496 skills, USDC on Base, MNNC-1.0)',
        ],
        knownDiscrepancies: [
          'Smithery HTML still shows "9,248" in some cached views (their crawler may not have re-indexed our 66,496 update yet)',
        ],
        notes:
      ...
      },
      {
        ...
        knownDiscrepancies: [
          'Listing says "9,248 verified MCP-compatible skills" — stale; current catalog is 66,496 indexed (with install-risk + trust tiers, not blanket "verified")',
      ...
      },
      {
        ...
        notes:
          'Glama.ai appears to have indexed MarketNow. Verify the listing shows current numbers (66,496 skills, USDC on Base, MNNC-1.0). If stale, Glama\'s crawler should refresh within 7-14 days.',
      },
      {
        name: 'PulseMCP',
    ...
    listings: [
      {
        ...
        lastChecked: '2026-07-04',
        whatWeFixed: [
          'v1.2.0: la descripción decía "66,496+ verified skills" → "66,496 MCP-compatible skills"',
      ...
      },
      {
        ...
        whatWeFixed: [
          ...
          'Nuestro server-card.json está actualizado con los números actuales (66,496 skills, USDC on Base, MNNC-1.0)',
        ],
        knownDiscrepancies: [
          'El HTML de Smithery todavía muestra "66,496" en algunas vistas cacheadas (su crawler puede no haber re-indexado aún)',
        ],
        notes:
      ...
      },
      {
        ...
        knownDiscrepancies: [
          'El listado dice "66,496 verified MCP-compatible skills" — debería ser 66,496',
      ...
      },
      {
        ...
        notes:
          'Glama.ai parece haber indexado MarketNow. Verifica que el listado muestre los números actuales (66,496 skills, USDC on Base, MNNC-1.0). Si está desactualizado, el crawler de Glama debería refrescar en 7-14 días.',
      },
      {
        name: 'PulseMCP',
        url: 'https://www.pulsemcp.com',
    ...
    listings: [
      {
        ...
        lastChecked: '2026-07-04',
        whatWeFixed: [
          'v1.2.0: a descrição dizia "66,496+ verified skills" → "66,496 MCP-compatible skills"',
      ...
      },
      {
        ...
        whatWeFixed: [
          ...
          'Nosso server-card.json está atualizado com os números atuais (66,496 skills, USDC on Base, MNNC-1.0)',
        ],
        knownDiscrepancies: [
          'O HTML do Smithery ainda mostra "66,496" em algumas views em cache (o crawler pode não ter re-indexado ainda)',
        ],
        notes:
      ...
      },
      {
        ...
        knownDiscrepancies: [
          'A listagem diz "66,496 verified MCP-compatible skills" — deveria ser 66,496',
      ...
      },
      {
        ...
        notes:
          'Glama.ai parece ter indexado o MarketNow. Verifique se a listagem mostra os números atuais (66,496 skills, USDC on Base, MNNC-1.0). Se desatualizada, o crawler da Glama deve atualizar em 7-14 dias.',
      },
      {
        name: 'PulseMCP',
        url: 'https://www.pulsemcp.com',
    ...
    listings: [
      {
        ...
        lastChecked: '2026-07-04',
        whatWeFixed: [
          'v1.2.0：描述中曾写为 "66,496+ verified skills" → "66,496 MCP-compatible skills"',
      ...
      },
      {
        ...
        whatWeFixed: [
          ...
          '我们的 server-card.json 已更新为当前数据（66,496 skills，USDC on Base，MNNC-1.0）',
        ],
        knownDiscrepancies: [
          'Smithery 的 HTML 在某些缓存视图中仍显示 "66,496"（其爬虫可能尚未重新索引）',
        ],
        notes:
      ...
      },
      {
        ...
        knownDiscrepancies: [
          '列表写的是 "66,496 verified MCP-compatible skills" —— 应为 66,496',
      ...
      },
      {
        ...
        notes:
          'Glama.ai 似乎已索引 MarketNow。请核实列表显示的是当前数据（66,496 skills，USDC on Base，MNNC-1.0）。如已过时，Glama 的爬虫应在 7-14 天内刷新。',
      },
      {
        name: 'PulseMCP',
        url: 'https://www.pulsemcp.com',
    ...
    listings: [
      {
        ...
        lastChecked: '2026-07-04',
        whatWeFixed: [
          'v1.2.0 : la description disait "66,496+ verified skills" → "66,496 MCP-compatible skills"',
      ...
      },
      {
        ...
        whatWeFixed: [
          ...
          'Notre server-card.json est à jour avec les chiffres actuels (66,496 skills, USDC on Base, MNNC-1.0)',
        ],
        knownDiscrepancies: [
          'Le HTML de Smithery affiche encore "66,496" dans certaines vues en cache (leur crawler n\'a peut-être pas encore ré-indexé)',
        ],
        notes:
      ...
      },
      {
        ...
        knownDiscrepancies: [
          'Le listing dit "66,496 verified MCP-compatible skills" — devrait être 66,496',
      ...
      },
      {
        ...
        notes:
          'Glama.ai semble avoir indexé MarketNow. Vérifiez que le listing affiche les chiffres actuels (66,496 skills, USDC on Base, MNNC-1.0). Si obsolète, le crawler de Glama devrait se rafraîchir en 7-14 jours.',
      },
      {
        name: 'PulseMCP',
        url: 'https://www.pulsemcp.com',
