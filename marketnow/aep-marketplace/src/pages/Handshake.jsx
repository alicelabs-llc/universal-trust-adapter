...
const CONTENT = {
  en: {
    ...
    pricingDescPre: 'Free skills install at no cost. Premium skills have a price set by the seller. Sellers subscribe to Sentinel (PRO $9.99/mo, ENTERPRISE $49.99/mo). ',
  ...
  es: {
    ...
    pricingDescPost: '.',
    pricingTiers: [
      { price: "Gratis", label: "Compradores", desc: "Todos los skills se instalan gratis. Sin pago." },
  ...
  pt: {
    ...
    pricingDescPost: '.',
    pricingTiers: [
      { price: "Grátis", label: "Compradores", desc: "Todas as skills são gratuitas. Sem pagamento." },
  ...
  zh: {
    ...
    workflowSteps: [
      ...
      { step: '4', title: '购买', desc: '一次性 Free-$9.99' },
  ...
  fr: {
    ...
    workflowSteps: [
      ...
      { step: '4', title: 'Acheter', desc: 'Paiement unique Free-$9.99' },
