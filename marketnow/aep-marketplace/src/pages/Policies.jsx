...
All 68,388 skills are FREE to install and use. MarketNow does not sell skills and does not charge anyone — no subscriptions, no commissions, no fees.`,
      },
      {
        title: 'Refund Policy',
...
Todas las 68,388 skills son gratuitas: no hay precio mínimo ni máximo, no hay pagos. Los agentes pueden descubrir, evaluar e instalar skills programáticamente vía la API pública en /api/skills.json.`,
      },
      {
...
As 68,388 skills são gratuitas: não há preço mínimo nem máximo, não há pagamentos. Agentes podem descobrir, avaliar e instalar skills programaticamente via a API pública em /api/skills.json.`,
      },
      {
        title: 'Política de Reembolso',
...
所有 68,388 个技能都免费：没有最低或最高价格，不存在付款。Agent 可通过公开 API /api/skills.json 以编程方式发现、评估并安装 skill。`,
      },
      {
